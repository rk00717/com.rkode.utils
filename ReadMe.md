...
# RKode Utility
### `com.rkode.utils` · v0.5.0 · Unity 2021.3+
...
[![Version](https://img.shields.io/badge/Version-0.5.0-0a0c08?style=flat-square&logoColor=c9933a)]()
...
| `SingletonConfig` | Allows user to create Singleton automatically without manual setup. |
